...
(defn- pom-template
  ...
  [version-tag]
  [[:description "Observability library to instrument Clojure code."]
   ...
   [:scm
    [:url "https://github.com/amperity/ken"]
    [:connection "scm:git:https://github.com/amperity/ken.git"]
    [:developerConnection "scm:git:ssh://git@github.com/amperity/ken.git"]
    [:tag version-tag]]])
